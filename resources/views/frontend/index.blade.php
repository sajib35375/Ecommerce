                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image"> <img src="{{ $deals->product_thumbnail }}" alt=""> </div>
                                        @php
                                                ...
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="{{ route('product.details',$offers->id) }}"> <img src="{{ asset($offers->product_thumbnail) }}" alt=""> </a> </div>
                                                            <!-- /.image -->
                                        ...
                                        <div class="product">
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                    <div class="col col-xs-5">
                                                        <div class="product-image">
                                                            <div class="image"> <a href="{{ route('product.details',$special->id) }}"> <img src="{{ $special->product_thumbnail }}"  alt=""> </a> </div>
                                                            <!-- /.image -->
                    ...
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"> <a href="{{ route('product.details',$category->id) }}"><img  src="{{ asset( $category->product_thumbnail ) }}" alt=""></a> </div>
                                        <!-- /.image -->
